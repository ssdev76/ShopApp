...
/******/ 	__webpack_require__.p = "/reactjs/public/";
/******/
/******/
...
var _ShoppingList = __webpack_require__(27);
...
var TestConfirmit = function (_React$Component) {
  _inherits(TestConfirmit, _React$Component);

  function TestConfirmit() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, TestConfirmit);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TestConfirmit.__proto__ || Object.getPrototypeOf(TestConfirmit)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(TestConfirmit, [{
    key: 'render',
    value: function render() {
      ...
      var articles = [{
        ...
        id: 2,
        title: 'TEST-2',
        text: 'TEST-2!TEST-2!TEST-2!',
        comments: [{
          id: 1,
          author: 'vas2',
          text: "Hi! I'm the Best"
        }, {
          id: 2,
          author: 'zak2',
          text: 'You are very stupid!!!'
        }]
      }, {
        id: 3,
        title: 'TEST-3',
        text: 'TEST-3!TEST-3!TEST-3!'
      }];
  ...
  return TestConfirmit;
}(_react2.default.Component);

// ========================================

_reactDom2.default.render(_react2.default.createElement(TestConfirmit, null), document.getElementById('root'));
...
var _accordeon = __webpack_require__(47);
	...
	_createClass(ArticleList, [{
  	...
  	openArticleId: null
		...
		value: function render() {
			...
			var articleElements = this.props.articles.map(function (article) {
				return _react2.default.createElement(
					'li',
					{ key: article.id },
					_react2.default.createElement(_Article2.default, {
						article: article,
						isOpen: article.id === _this2.props.openItemId,
						toggleOpen: function toggleOpen() {
							return _this2.props.toggleOpenItem(article.id);
						}
					})
				);
			});
		...
		/*
  toogleOpenArticle(openArticleId){
...
ArticleList.propTypes = {
	...
	openItemId: _propTypes2.default.number, // !!!!! forget
	toggleOpenItem: _propTypes2.default.func // !!!!! forget
};
exports.default = (0, _accordeon2.default)(ArticleList);
...
//import toggleOpen from '../decorators/toggleOpen'; - with decorators
...
var Article = function (_React$Component) {
	...
	function Article() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Article.__proto__ || Object.getPrototypeOf(Article)).call.apply(_ref, [this].concat(args))), _this), _this.setCommentsRef = function (ref) {
			console.log('---', ref);
			//ref.focus(); //- method of CommentList
  	...
  	this.state = {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ onClick: function onClick() {
							return _this2.props.toggleOpen();
						} },
		...
		value: function getBody() {
			...
			return _react2.default.createElement(
				...
				null,
				article.text,
				_react2.default.createElement(_CommentList2.default, { comments: article.comments, ref: this.setCommentsRef })
			);
		}
...
//export default toggleOpen(Article) - with decorators
...
Article.propTypes = {
	...
	isOpen: _propTypes2.default.bool, // !!!!! forget
	toggleOpen: _propTypes2.default.func // !!!!! forget
};
...
var _toggleOpen = __webpack_require__(34);
	...
	_createClass(CommentList, [{
  	...
  	this.state = {
		...
		value: function render() {
			...
			var textButton = this.props.isOpen ? 'hide comments' : 'show comments';
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(
...
CommentList.propTypes = {
	comments: _propTypes2.default.array,
	isOpen: _propTypes2.default.bool, // !!!!! forgot
	toggleOpen: _propTypes2.default.func // !!!!! forgot
};
CommentList.defaultProps = {
	comments: [] };
exports.default = (0, _toggleOpen2.default)(CommentList); //- with decorators
...
exports.default = function (OriginalComponent) {
		...
		_createClass(WrappedComponent, [{
			...
			value: function render() {
				return (
					...
					_react2.default.createElement(OriginalComponent, _extends({}, this.props, this.state, { toggleOpen: this.toggleOpen }))
				);
			}
		}]);
...
var _ReplaceTransition = __webpack_require__(42);
...
var _removeClass = __webpack_require__(39);
...
exports.default = function (OriginalComponent) {
	return function (_React$Component) {
		_inherits(Accordeon, _React$Component);
		...
		function Accordeon() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Accordeon.__proto__ || Object.getPrototypeOf(Accordeon)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				//openArticleId: null - better openItemId
				openItemId: null

				/*!!!ERROR!!! componentWillUpdate(nextProps,nextState){
    	debugger;
    	if (this.state.openArticleId != null && this.state.openArticleId === nextState.openArticleId){
    		this.setState({
    			openArticleId: null
    		})
    	}
			...
			}, _this.toggleOpenItem = function (openItemId, ev) {
				// better
				ev && ev.preventDefault && ev.preventDefault();
    	...
    	openArticleId = null;
				...
				_this.setState({
					...
					openItemId: openItemId === _this.state.openItemId ? null : openItemId // better
				});
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
		...
		_createClass(Accordeon, [{
			...
			value: function render() {
				return (
					...
					_react2.default.createElement(OriginalComponent, _extends({}, this.props, this.state, { toggleOpenItem: this.toggleOpenItem })) // better
...
module.exports = __webpack_require__.p + "fonts/glyphicons-halflings-regularf4769f9bdb7466be65088239c12046d1.eot";

/***/ }),
/* 52 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/glyphicons-halflings-regular448c34a56d699c29117adc64c43affeb.woff2";

/***/ }),
/* 53 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/glyphicons-halflings-regularfa2772327f55d8198301fdb8bcfc8158.woff";

/***/ }),
/* 54 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/glyphicons-halflings-regulare18bbf611f2a2e43afc071aa2f4e1512.ttf";

/***/ }),
/* 55 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/glyphicons-halflings-regular89889688147bd7575d6327160d64e760.svg";
